...
from xlstm_solace_torch.components.conv import CausalConv1d, CausalConv1dConfig
from xlstm_solace_torch.mad.init import small_init_init_, wang_init_
from xlstm_solace_torch.components.linear_headwise import (
    LinearHeadwiseExpand,
    LinearHeadwiseExpandConfig,
)
from xlstm_solace_torch.utils import UpProjConfigMixin
