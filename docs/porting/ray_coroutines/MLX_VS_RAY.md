...
This document contrasts the MLX path and the Ray‑coordinated PyTorch MPS path. Both execute core math on Apple GPUs;
they differ in orchestration, streams, and tooling.
