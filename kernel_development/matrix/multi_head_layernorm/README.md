...
- Explore MLX (Metal) performance and stability improvements for xLSTM with lab-first prototypes, measurements, and
  reports before integration.

Contents

- Scripts: benches and parity checks for soft caps, per‑head linear, head‑aware LN, GEMM tiling, sequence precompute,
  smoke and parity tests.
