...
class WiredMADModel(nn.Module):
    ...
    Example:
        >>> from xlstm_metal.wiring.mlx import create_xlstm_wiring, WiredMADModel
        >>> config = {'embedding_dim': 4096, 'num_heads': 8, 'num_blocks': 32, 'vocab_size': 50304, 'qk_dim_factor': 0.5, 'v_dim_factor': 1.0, 'ffn_proj_factor': 2.671875}
