...
This is xLSTM-metal - Metal acceleration is required.
"""

import mlx.core as mx
from typing import Tuple, Optional

# Import Metal kernel implementations directly  
from .forward.mlstm_chunkwise_recurrent_fw_C import (
    mlstm_chunkwise_recurrent_fw_C_metal
)
from .forward.mlstm_chunkwise_parallel_fw_Hintra import (
