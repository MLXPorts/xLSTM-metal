...
from xlstm_metal.torch_native.blocks.slstm.slstm_layers.slstm_neuron import sLSTMNeuron
...
class sLSTMBlock(nn.Module):
    ...
    def __init__(
        ...
        self.norm_slstm = RMSNormCell(dims=embedding_dim, eps=norm_eps)
        ...
        self.norm_ffn = RMSNormCell(dims=embedding_dim, eps=norm_eps)
    ...
    def forward(self, x: torch.Tensor, state=None) -> Tuple[torch.Tensor, Tuple]:
        """
        ...
        # SwiGLU FFN
        gate = F.silu(self.ffn_proj_up_gate(x_normed))
