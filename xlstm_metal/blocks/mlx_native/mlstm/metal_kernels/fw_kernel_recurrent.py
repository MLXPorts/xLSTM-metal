...
def _compile_recurrent_kernel():
    ...
    return mx.fast.metal_kernel(name="mlstm_recurrent_fw_C",
                                ...
                                output_names=["matC_states", "vecN_states", "scaMinter_states", "dbg"], header=_HEADER,
...
def _get_kernel():
    ...
    from xlstm_metal.kernels.mlx_fast_metal_kernels.kernel_registry import get_kernel
